        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-neutral-500 max-w-md leading-relaxed">
              Tạo tài khoản để tham gia chuỗi cung ứng nông sản an toàn AgriTrust.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-10 shadow-md space-y-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Ví dụ: HTX Lúa Chín, Cty Nông sản Xanh..."
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-[#15803D] hover:bg-[#166534] disabled:bg-slate-300 text-white rounded-2xl text-sm font-bold shadow-md shadow-emerald-900/10 hover:shadow-emerald-900/20 active:scale-98 transition-all flex items-center justify-center gap-2 cursor-pointer mt-2"
            >
              {isLoading ? (
